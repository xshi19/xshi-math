...
the nine adapted tail notes and the expanded local gate.

| Surface | Current responsibility |
| --- | --- |
| `myst.yml`, `content/` | One twenty-one-page book-theme site: the index, three track hubs, two original worked examples, six IG entry notes, and nine adapted Incerto notes |
...
| `docs/plan/` | Representative inventory, imported Batch 1 dispositions, remaining proposals, URL mappings, and pending gates |
...
The nine imported `incerto-*.md` notes follow the counting example beneath
`incerto.md`; their former executable cells are static calculations. No new
Python helpers, plotting dependencies, or notebook execution are required.
...
owns public assembly; no workflow here writes to it. Nine approved Incerto wiki
bodies are adapted with source notices; no private history, Lean project, CI
