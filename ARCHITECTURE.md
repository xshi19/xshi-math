...
| --- | --- |
| `myst.yml`, `content/` | One fifty-one-page book-theme site: the index, three track hubs, two original worked examples, six IG entry notes, twenty-three adapted Incerto notes and three concept indexes, and thirteen adapted Normix notes |
...
`incerto.md`; their former executable cells are static calculations. The thirteen
